...
class PacMan:
    ...
    def IsAlive(self,x1,y1,x2,y2,x3,y3,x4,y4,map):
        if(not (self.IsAlive1(x1,y1,map) and self.IsAlive1(x2,y2,map) and self.IsAlive1(x3,y3,map) and self.IsAlive1(x4,y4,map))):
            self.isAlive = False
        return self.isAlive
